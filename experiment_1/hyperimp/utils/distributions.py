""" 
from openmlstudy14 @author: janvanrijn 

Classes to enable drawing uniform samples from a logarithmic range.
...
class loguniform_gen(OpenMLDistributionHelper, rv_continuous):
    ...
    _rvs :  generate random numbers from a discrete log-uniform distribution 
            with base base, between low and high.
    """
...
class loguniform_int_gen(OpenMLDistributionHelper, rv_discrete):
    """
    A log-uniform discrete random variable.
